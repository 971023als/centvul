...
if [ -f /etc/pam.d/system-auth ]; then
  ...
  min_ucase=$(grep "pam_tally2.so " /etc/pam.d/system-auth | grep "ucredit" | awk -F"=" '{print $2}')
  ...
  min_lcase=$(grep "pam_tally2.so " /etc/pam.d/system-auth | grep "lcredit" | awk -F"=" '{print $2}')
  ...
  min_num=$(grep "pam_tally2.so " /etc/pam.d/system-auth | grep "dcredit" | awk -F"=" '{print $2}')
  ...
  min_spec=$(grep "pam_tally2.so " /etc/pam.d/system-auth | grep "ocredit" | awk -F"=" '{print $2}')
